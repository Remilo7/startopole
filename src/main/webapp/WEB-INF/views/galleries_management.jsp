    ...
    <form:form action="gallery.do" method="post" modelAttribute="gallery">
            ...
            <div class="col-md-6 panel_window">
                ...
                <table class="table table-hover table-responsive">
                    ...
                    <c:forEach items="${galleryList}" var="gallery">
                        <tbody>
                        <tr>
                            <td><form:radiobutton path="id" value="${gallery.id}"/></td>
                            <td>${gallery.name}</td>
                            <td>${gallery.added_date}</td>
                        </tr>
                        </tbody>
                    </c:forEach>
                </table>
        ...
        <div class="row">
            ...
            <div class="col-md-6 no-padding">
                ...
                <div class="col-md-3 newsButtons">
                    <button class="btn btn-green btn-border pull-right" name="action" value="Redirect">Dodaj</button>
                </div>
            </div>
        </div>
    </form:form>
