...
<head>
    ...
    <title>Zarządzanie sekcją - zawodnicy</title>
...
<div class="user_panel container-fluid no-padding">
    <div class="row">
        ...
        <div class="col-md-6 text-center">
            <h1>Zarządzaj akapitami w sekcji - zawodnicy</h1>
        </div>
    </div>
    <form:form action="members.do" method="post" modelAttribute="section" commandName="section">
        <div class="row">
            <div class="col-md-3"></div>
